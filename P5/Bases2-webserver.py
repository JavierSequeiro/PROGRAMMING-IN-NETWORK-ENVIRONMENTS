...
class TestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path == "/":
            ...
            contents = read_html_file("./HTML_FILES/info/C.html")

        elif self.path == "/info/T":
            contents = read_html_file("./HTML_FILES/info/T.html")

        elif self.path == "/info/G":
            contents = read_html_file("./HTML_FILES/info/G.html")

        elif self.path == "/info/A":
            contents = read_html_file("./HTML_FILES/info/A.html")
        else:
            try:
